...
cs1 = threading.Thread(name='consumer1', target=consumer, args=(condition, "thread-1"))
cs2 = threading.Thread(name='consumer2', target=consumer, args=(condition, "thread-2"))
